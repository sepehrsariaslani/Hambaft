                  ...
                  <div className="flex items-center gap-2">
                    {!isEditing && (
                      <>
                        ...
                        {(area.activeProjectCount ?? area.projectCount) != null && (
                          <span className="text-[10px] font-bold bg-blue-50 text-blue-700 px-2 py-1 rounded-lg">{area.activeProjectCount ?? area.projectCount} پروژه</span>
                        )}
                        {(area.milestoneTotal ?? 0) > 0 && (
                          <span className="text-[10px] font-bold bg-[#F9F1D8] text-[#5A5A40] px-2 py-1 rounded-lg">◆ {area.milestoneDone ?? 0}/{area.milestoneTotal}</span>
                        )}
                        {(area.keyTotal ?? 0) > 0 && (
                          <span className="text-[10px] font-bold bg-blue-50 text-blue-700 px-2 py-1 rounded-lg">★ {area.keyDone ?? 0}/{area.keyTotal}</span>
                        )}
